                  ...
                  <div class="accordion-group">
                    ...
                    <div class="accordion-body collapse" id="collapse{{$category->id}}" style="height: 0px;">
                      <div class="accordion-inner">
                        ...
                        $subcats = App\Models\subCategory::where('category_id',$category->id)->orderBy('sub_category_eng','ASC')->get();
                        ...
                        <ul>
     <li><a href="{{url('subcategory/product').'/'.$subcat->sub_category_eng_slug.'/'.$subcat->id}}">{{$subcat->sub_category_eng}}</a></li>
            ...
            <div class="sidebar-widget wow fadeInUp">
              ...
              <div class="sidebar-widget-body">
                ...
                @foreach($color as $dcolor)
                <ul class="list">
                  <li><a href="#">{{str_replace(',',' ',$dcolor->product_color_eng) }}</a></li>
              ...
              <div class="category-product">
                <div class="row">
                  ...
                  <div class="col-sm-6 col-md-4 wow fadeInUp">
                   ...
                   $amount = $product->seeling_price - $product->discount_price;

                   $discd = ( $amount / $product->seeling_price) * 100;
